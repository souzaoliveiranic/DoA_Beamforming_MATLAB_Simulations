...
n_rand_angles  = 100;    % quantos pares (phi_sig, phi_int) sortear
...
range_coupling = [0, 1, 2, 4, 6, 7, 8, 9, 11, 12, 13, 14];
        ...
        for rep = 1:n_rep_iter
            ...
            for im = 1:nMet_it
                [~, ~, ~, ~, hist_it] = estimate_C_selfcal(Xk, qv, M, exp_radius_m, lambda, ...
                    sc_meth_list{im}, selfcal_grid_deg, max_it, [], [], Cmat, ...
